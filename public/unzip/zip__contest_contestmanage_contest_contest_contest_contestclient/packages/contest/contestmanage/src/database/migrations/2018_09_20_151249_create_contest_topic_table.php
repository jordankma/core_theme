...
class CreateContestTopicTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_cuocthi')->create('contest_topic', function (Blueprint $table) {
            ...
            $table->text('question_pack_id');
            $table->unsignedInteger('topic_exam_repeat_condition');
            $table->unsignedInteger('topic_point_condition');
            $table->unsignedInteger('topic_point_method');
