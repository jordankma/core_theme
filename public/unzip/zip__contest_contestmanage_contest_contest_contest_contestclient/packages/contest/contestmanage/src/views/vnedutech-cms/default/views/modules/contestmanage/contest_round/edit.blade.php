                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                {!! Form::text('name', !empty($round->display_name)?base64_decode($round->display_name):null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_round.name_here'))) !!}
                            ...
                            <div class="form-group {{ $errors->first('description', 'has-error') }}">
                                {!! Form::textarea('description', !empty($round->description)?base64_decode($round->description):null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_round.description'))) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <label>Điều kiện vòng thi (*)</label>
                            <div class="form-group {{ $errors->first('round_condition', 'has-error') }}">
                                {!! Form::select('round_condition', !empty($round_condition)?$round_condition:array(),null, array('class' => 'form-control')) !!}
                                <span class="help-block">{{ $errors->first('round_condition', ':message') }}</span>
                            </div>

                            <label>Cách tính điểm vòng thi (*)</label>
                            <div class="form-group {{ $errors->first('round_point_method', 'has-error') }}">
                                {!! Form::select('round_point_method', $round_point_method,null, array('class' => 'form-control')) !!}
                                <span class="help-block">{{ $errors->first('round_point_method', ':message') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->first('end_notify', 'has-error') }}">
                                {!! Form::textarea('end_notify', !empty($round->end_notify)?base64_decode($round->end_notify):null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_round.after_end_notify'))) !!}
