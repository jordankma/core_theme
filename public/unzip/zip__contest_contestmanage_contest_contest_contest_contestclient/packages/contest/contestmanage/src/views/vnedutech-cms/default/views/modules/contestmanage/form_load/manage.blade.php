...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.form_load.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('contest.contestmanage.form_load.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('contest-contestmanage::language.table.form_load.title') }}</th>
                                <th>{{ trans('contest-contestmanage::language.table.form_load.alias') }}</th>
                                <th>{{ trans('contest-contestmanage::language.table.form_load.field') }}</th>
