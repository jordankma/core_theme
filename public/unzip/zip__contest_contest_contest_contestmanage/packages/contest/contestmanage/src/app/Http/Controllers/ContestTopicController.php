...
class ContestTopicController extends Controller
{
    ...
    public function __construct( ContestTopicRepository $topicRepository, TopicConfigRepository $topicConfigRepository)
    {
        parent::__construct();
    ...
    public function add(TopicRequest $request)
    {
        ...
        $topic->question_pack_id = $request->question_pack_id;
        $topic->status = '1';
