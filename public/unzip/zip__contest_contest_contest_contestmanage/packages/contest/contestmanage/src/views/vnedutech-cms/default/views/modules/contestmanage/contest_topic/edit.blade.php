                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->first('round', 'has-error') }}">
                                {!! Form::text('round', $topic->round->display_name, array('class' => 'form-control round', 'autofocus'=>'autofocus', 'readOnly' => 'readOnly', 'placeholder'=> trans('contest-contestmanage::language.placeholder.contest_topic.round'))) !!}
                                        ...
                                        @foreach($topic_round as $key=>$value)
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="topic_round[{{ $key }}][rule_text]" class="form-control" id="ckeditor_full{{ $key }}">{{ !empty($value->rule_text)?$value->rule_text:'' }}</textarea></div>
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
