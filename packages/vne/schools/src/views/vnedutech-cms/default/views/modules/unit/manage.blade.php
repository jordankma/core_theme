            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('vne.unit.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th class="datatable">{{ trans('vne-schools::language.label.unitname') }}</th>
                                <th class="datatable">{{ trans('vne-schools::language.label.type') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                ...
                paging: true,
                ajax: {
                    url: '{{ route('vne.unit.data') }}'
                },
                columns: [
                    {data: '_id', name: '_id'},
                    {data: 'unitname', name: 'unitname'},
                    {data: 'type', name: 'type'},
                    {data: 'unitaddress', name: 'unitaddress'},
                    {data: 'unitphone', name: 'unitphone'},
                    {data: 'unitprovince', name: 'unitprovince'},
                    {data: 'unitdistrict', name: 'unitdistrict'},
                    {data: 'unitmem', name: 'unitmem'},
