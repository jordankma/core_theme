...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-unit::language.titles.demo.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($catunit, ['url' => route('vne.catunit.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-lg-9 col-12{{ $errors->first('catunit', 'has-error') }} ">
                                <input id="catunit" name="catunit" type="text"
                                       placeholder="{{ trans('vne-schools::language.placeholder.unitname') }}"
                                       class="form-control" value="{{$catunit->catunit}}" autofocus required>
                                <span class="help-block">{{ $errors->first('catunit', ':message') }}</span>
                            </div>
                            <div class="form-group">
                                {!! Form::hidden('_id') !!}
                            </div>
