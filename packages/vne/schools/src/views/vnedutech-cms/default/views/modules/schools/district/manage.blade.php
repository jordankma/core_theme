            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('vne.schools.district.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('vne-schools::language.buttons.adddistrict') }}
                        </a>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('vne-schools::language.table.province') }}</th>
                                <th>{{ trans('vne-schools::language.table.district') }}</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#table').DataTable({
                ...
                ajax: {
                    url:'{{ route('vne.schools.district.data') }}',
                },
                columns: [
