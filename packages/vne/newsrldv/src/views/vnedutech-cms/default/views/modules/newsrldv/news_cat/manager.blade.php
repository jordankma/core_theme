...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-newsrldv::language.titles.news_cat.list') }} @stop
{{-- page styles --}}
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            @if ($USER_LOGGED->canAccess('vne.newsrldv.cat.create'))
                                <a href="{{ route('vne.newsrldv.cat.create') }}" class="btn btn-sm btn-default"><span
                            ...
                            <table class="table table-bordered" id="table">
                                <thead>
                                    <tr>                                             
                                        ...
                                        {{-- <th style="width: 120px">{{ trans('vne-newsrldv::language.table.list_news_cat.title_cat_paren') }}</th> --}}
                                        ...
                                        <th class="fit-content" style="width: 100px">{{ trans('vne-newsrldv::language.table.action') }}</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.newsrldv.cat.data') }}',
                columns: [
