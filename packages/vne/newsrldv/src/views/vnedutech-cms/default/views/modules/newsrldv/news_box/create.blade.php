...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-newsrldv::language.titles.news_box.add') }} @stop
{{-- page styles --}}
...
@section('content')
    ...
    <section class="content paddingleft_right15">
            <div class="the-box no-border">
                <div class="row">
                        <form action="{{route('vne.newsrldv.box.add')}}" method="post" id="form-add-box">
                            <div class="col-md-5" style="">
                                <label for="input-text-1">{{trans('vne-newsrldv::language.label.name')}}</label>
                                <div class="form-group ui-draggable-handle" style="position: static;">
                                    <input type="text" name="name" class="form-control" id="input-text-1" placeholder="{{trans('vne-newsrldv::language.form.boxs_placeholder')}}">
                                </div>
                            </div>
