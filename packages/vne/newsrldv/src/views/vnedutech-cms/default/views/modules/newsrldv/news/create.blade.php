...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-newsrldv::language.titles.news.add') }} @stop
{{-- page styles --}}
    ...
    <!--main content-->
        <div class="row">
            <div class="the-box no-border">
                <form role="form" action="{{route("vne.newsrldv.news.add")}}" method="post" enctype="multipart/form-data" id="form-add-news">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control" placeholder="{{trans('vne-newsrldv::language.form.title_placeholder')}}">
                                <p id="alias" style="color: red"></p>
                            </div>
                            <div class="form-group">
                                <label>{{trans('vne-newsrldv::language.form.text.desc')}}</label><br>
                                <textarea rows="5" cols="101" name="desc" class="form-control" placeholder="{{trans('vne-newsrldv::language.form.desc_placeholder')}}"></textarea>
                            </div>
                            {{-- <div class="form-group">
                                <label for="news-text">
                            ...
                            <div class="area-new-text" style="display: block;">
                                <div class="form-group">
                                    ...
                                    <div class='box-body pad form-group'>
                                        <textarea name="content" id="ckeditor" placeholder="{{trans('vne-newsrldv::language.form.content_placeholder')}}"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <label>{{trans('vne-newsrldv::language.form.text.image')}} <span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <div class="input-group">
                                   <span class="input-group-btn">
                                     <a id="lfm2" data-input="thumbnail2" data-preview="holder2" class="btn btn-primary">
                                       <i class="fa fa-picture-o"></i> {{trans('vne-newsrldv::language.label.choise_image_display')}}
                                     </a>
                                   </span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" min="0" type="number" name="priority" value="" placeholder="{{trans('vne-newsrldv::language.form.priority_placeholder')}}">
                            </div>
                            <div class="form-group">
                                <label>{{trans('vne-newsrldv::language.form.text.key_seo')}}</label> <br>
                                <input type="text" name="key_word_seo[]" class="form-control" data-role="tagsinput" placeholder="{{trans('vne-newsrldv::language.form.seo_key_word_placeholder')}}">
                            </div>
                            <div class="form-group">
                                <label>{{trans('vne-newsrldv::language.form.text.desc_seo')}}</label>
                                <textarea rows="5" cols="101" name="desc_seo" class="form-control" placeholder="{{trans('vne-newsrldv::language.form.desc_seo_placeholder')}}"></textarea>
                            </div>
                        </div>
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-success">{{trans('vne-newsrldv::language.buttons.create')}}</button>
                            <a href="{{route("vne.newsrldv.news.manager")}}" class="btn btn-danger">{{trans('vne-newsrldv::language.buttons.discard')}}</a>
                        </div>
                        <!-- /.col-sm-4 -->
                    </div>
                    <!-- /.row -->
