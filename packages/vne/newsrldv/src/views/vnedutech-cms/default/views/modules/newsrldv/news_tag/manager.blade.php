...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-newsrldv::language.titles.news_tag.list') }} @stop
{{-- page styles --}}
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            @if ($USER_LOGGED->canAccess('vne.newsrldv.tag.create'))
                                <a href="{{ route('vne.newsrldv.tag.create') }}" class="btn btn-sm btn-default"><span
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.newsrldv.tag.data') }}',
                columns: [
