...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-newsrldv::language.titles.news_box.edit') }} @stop
{{-- page styles --}}
...
@section('content')
    ...
    <section class="content paddingleft_right15">
            <div class="the-box no-border">
                <div class="row">
                        <form action="{{route('vne.newsrldv.box.update')}}" method="post" id="form-add-box">
                            ...
                            <div class="col-md-5" style="">
                                ...
                                <div class="form-group ui-draggable-handle" style="position: static;">
                                    <input type="text" name="name" value="{{$news_box->name}}" class="form-control" id="input-text-1" placeholder="{{trans('vne-newsrldv::language.form.boxs_placeholder')}}">
                                </div>
                                <label for="input-text-1">{{trans('vne-newsrldv::language.label.alias')}}</label>
                                <div class="form-group ui-draggable-handle" style="position: static;">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{route('vne.newsrldv.box.manager')}}" class="btn btn-danger">{{trans('vne-newsrldv::language.buttons.discard')}}</a>
                            </div>
                        </form>
                </div>
            </div>
