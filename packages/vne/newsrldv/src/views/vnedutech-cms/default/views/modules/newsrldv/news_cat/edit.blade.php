...
@section('content')
    ...
    <section class="content paddingleft_right15">
            <div class="the-box no-border">
                <div class="row">
                        <form action="{{route('vne.newsrldv.cat.update')}}" method="post" id="form-add-cat">
                            ...
                            <div class="col-md-5" style="">
                                <div class="form-group ui-draggable-handle" style="position: static;">
                                    ...
                                    <input type="text" name="name" value="{{$news_cat->name}}" class="form-control" id="input-text-1" placeholder="{{trans('vne-newsrldv::language.form_cat.category_placeholder')}}">
                                </div>
