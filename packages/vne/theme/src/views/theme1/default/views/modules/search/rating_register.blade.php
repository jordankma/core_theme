	...
	<section class="section ratings">
		<div class="container">
			...
			<h1 class="headline">{{ $title }}</h1>
				...
				<div class="content">
					<h2 class="headline">Top thí sinh đăng ký theo tỉnh</h2>
					...
					<ol class="list">
						@foreach ($list_top_thi_sinh_dang_ky_tinh->data as $item)
							<li class="row">
					...
					@endif
					<h2 class="headline">Top thí sinh đăng ký theo trường</h2>
					...
					<ol class="list">
						@foreach ($list_top_thi_sinh_dang_ky_truong->data as $item)
							<li class="row">
								<div class="col-2 col-md-1 top">{{ $loop->index+1 }}</div>
								<div class="col-6 col-md-6 name-city">{{ $item->name }}</div>
								<div class="col-4 col-md-5 number">{{ $item->total }}</div>
