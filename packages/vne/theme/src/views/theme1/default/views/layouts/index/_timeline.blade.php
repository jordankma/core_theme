<div class="col-12">
	<section class="section timeline" style="background-image:url({{ config('site.url_static') . '/vendor/' . $group_name . '/' . $skin . '/src/images/bg-timeline.png?t=' . time() }});">
		...
		<div class="info">
			<div class="user user-registration">
				<img src="{{ config('site.url_static') . '/vendor/' . $group_name . '/' . $skin . '/src/images/cup2.png?t=' . time() }}" alt="">
				<div class="number">{{ $count_thi_sinh_dang_ky }}</div>
				<div class="title">THÍ SINH ĐĂNG KÝ</div>
			</div>
			<div class="user user-active">
				<img src="{{ config('site.url_static') . '/vendor/' . $group_name . '/' . $skin . '/src/images/flag.png?t=' . time() }}" alt="">
