...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-notification::language.titles.log_sent.manage') }}@stop
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('vne-notification::language.table.log_sent.create_by') }}</th>
                                <th>{{ trans('vne-notification::language.table.log_sent.notification') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.notification.log-sent.data') }}',
                columns: [
