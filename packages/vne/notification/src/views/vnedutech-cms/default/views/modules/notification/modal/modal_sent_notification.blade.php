<form action="{{ $confirm_route }}" method="post">
  ...
  <div class="modal-body row">
      ...
      @else
          <div class="col-md-8">
            ...
            {{-- <label>{{trans('vne-notification::language.label.time_sent') }}</label>
            <div class="form-group">
                <div class='input-group date'>
                    <input type='text' class="form-control" name="time_sent" id="time_sent" placeholder="{{trans('vne-notification::language.placeholder.notification.time_sent_here') }}"/>
  ...
  <div class="modal-footer" style="padding: 15px 240px;">
    ...
    <button type="submit" class="btn btn-danger">{{ trans('vne-notification::confirm.sent') }}</button>
  </div>
</form> 
