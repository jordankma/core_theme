...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-notification::language.titles.notification.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('vne.notification.notification.create'))
                        <a href="{{ route('vne.notification.notification.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> {{ trans('vne-notification::language.buttons.create') }}</a>
                        @endif
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('vne-notification::language.table.notification.name') }}</th>
                                <th>{{ trans('vne-notification::language.table.notification.content') }}</th>
                                <th class="fit-content">{{ trans('vne-notification::language.table.notification.sent') }}</th>
                                <th style="width: 120px">{{ trans('vne-notification::language.table.created_at') }}</th>
                                <th>{{ trans('vne-notification::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.notification.notification.data') }}',
                columns: [
