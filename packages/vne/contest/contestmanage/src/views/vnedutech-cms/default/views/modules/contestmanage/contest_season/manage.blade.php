                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('contest-contestmanage::language.table.contest_season.time') }}</th>
                                <th>{{ trans('contest-contestmanage::language.table.contest_season.config') }}</th>
        ...
        $(function () {
            var table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'season_id', name: 'config', "render": function (data) {
