...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.contest_tag.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('contest.contestmanage.contest_tag.create') }}" class="btn btn-sm btn-default">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('contest-contestmanage::language.table.contest_tag.name') }}</th>
                                <th>{{ trans('contest-contestmanage::language.table.contest_tag.alias') }}</th>
                                <th>{{ trans('contest-contestmanage::language.table.contest_tag.description') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('contest.contestmanage.contest_tag.data') }}',
                columns: [
