...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.contest_season.update') }}@stop
...
@section('content')
    ...
    <section class="content paddingleft_right15">
        ...
        <!--main content-->
        {!! Form::model($season, ['url' => route('contest.contestmanage.contest_season.update',['season_id' => $season->season_id]), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->first('name', 'has-error') }}">
                    {!! Form::text('name', $season->name, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.name_here'))) !!}
                    <span class="help-block">{{ $errors->first('name', ':message') }}</span>
                </div>
                <label>Thứ tự mùa (*)</label>
                <div class="form-group {{ $errors->first('number', 'has-error') }}">
                    {!! Form::number('number', $season->number, array('class' => 'form-control')) !!}
                    <span class="help-block">{{ $errors->first('number', ':message') }}</span>
                </div>
                <label>Cấu hình</label>

                <div class="form-group" id="config_container">
                    @if(!empty($season_config))
                        @php
                            $idx = 1;
                        @endphp
                        @foreach($season_config as $key => $value)
                            @php
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="start_date" class="form-control" value="{{$season->start_date}}" id="start_date"/>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="end_date" class="form-control" value="{{$season->end_date}}" id="end_date"/>
                </div>
                <label>Mô tả</label>
        ...
        <div class="row">
            ...
            <div class="form-group {{ $errors->first('rules', 'has-error') }}">
                {!! Form::textarea('rules', $season->rule, array('class' => 'form-control', 'id' => 'ckeditor_full','placeholder'=> trans('contest-contestmanage::language.placeholder.contest_season.rules'))) !!}
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <a href="{!! route('contest.contestmanage.contest_season.manage') !!}"
