...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.candidate.set_exam') }}@stop
        ...
        $('body').on('click','.search', function () {
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    ...
                    data: {table_id: table_id, city_id: city_id, district_id: district_id, school_id: school_id, name: name}
                },
                columns: [
                    { data: '_id', name: '_id' },
                    { data: 'name', name: 'name', defaultContent: '' },
...
//                    { data: 'actions', name: 'actions', orderable: false, searchable: false, className: 'fit-content'}
        ...
        $('body').on('click', '.export', function () {
            ...
            var link = route +'?table_id=' +table_id+ '&city_id=' + city_id+ '&district_id=' + district_id+ '&school_id=' + school_id+ '&name=' + name+ '&module=candidate';
