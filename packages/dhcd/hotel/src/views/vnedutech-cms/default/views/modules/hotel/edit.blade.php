    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($staff, ['url' => route('dhcd.hotel.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group {{ $errors->first('address', 'has-error') }}">
                                {!! Form::text('address', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('dhcd-hotel::language.placeholder.hotel.address'),'required')) !!}
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-md-offset-2">
                            <button type="submit" class="btn btn-success">{{ trans('dhcd-seat::language.buttons.save') }}</button>
                            <a href="{!! route('dhcd.hotel.create') !!}"
                               class="btn btn-danger">{{ trans('dhcd-seat::language.buttons.discard') }}</a>
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::hidden('hotel_id') !!}
                    <!-- /.col-sm-8 -->
                </div>
                <!-- /.row -->
...
@section('footer_scripts')
    <!-- begining of page js -->
    <script src="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/bootstrap-multiselect/js/bootstrap-multiselect.js') }}" language="javascript" type="text/javascript"></script>
