    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('dhcd.car.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'seatForm', 'files'=> true)) !!}
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-md-offset-2">
                        <button type="submit" class="btn btn-success">{{ trans('dhcd-car::language.buttons.create') }}</button>
                        <a href="{!! route('dhcd.car.create') !!}"
                           class="btn btn-danger">{{ trans('dhcd-car::language.buttons.discard') }}</a>
                    </div>
                </div>
                {!! Form::close() !!}
