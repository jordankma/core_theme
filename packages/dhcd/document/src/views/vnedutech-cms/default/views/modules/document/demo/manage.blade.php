            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('dhcd.document.demo.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('dhcd-document::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-document::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-document::language.table.updated_at') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('dhcd.document.demo.data') }}',
                columns: [
