    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($staff, ['url' => route('dhcd.seat.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                          <div class="row">
                            <div class="col-sm-6">
                                <label>Tên Đoàn (<span class="red">*</span>):</label>
                                <div class="form-group {{ $errors->first('doan_id', 'has-error') }}">
                                    {!! Form::text('doan_id' , $doan , array('class' =>'form-control', 'style' => 'width: 100%' , 'readonly')) !!}
                                ...
                                <div class="form-group {{ $errors->first('seat', 'has-error') }}">
                                    {!! Form::text('seat', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('dhcd-seat::language.placeholder.seat.name_here'))) !!}
