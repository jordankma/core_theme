            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('dhcd.seat.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('dhcd-seat::language.table.name') }}</th>
                                <th>{{ trans('dhcd-seat::language.table.session') }}</th>
                                <th>{{ trans('dhcd-seat::language.table.seat') }}</th>
                                <th>{{ trans('dhcd-seat::language.table.staff') }}</th>
                                <th>{{ trans('dhcd-seat::language.table.note') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('dhcd.seat.data') }}',
                columns: [
                    { data: 'rownum', name: 'rownum'},
                    { data: 'doan_id', name: 'doan_id' },
                    { data: 'sessionseat_name', name: 'sessionseat_id' },
                    { data: 'seat', name: 'seat' },
                    { data: 'seat_staff', name: 'seat_staff' },
                    { data: 'note', name :'note'},
