...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-api::language.titles.demo.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('dhcd.api.demo.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('dhcd-api::language.buttons.create') }}</a>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('dhcd-api::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-api::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-api::language.table.updated_at') }}</th>
                                <th>{{ trans('dhcd-api::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
