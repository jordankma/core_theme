...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-news::language.titles.page.edit') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form role="form" action="{{route("dhcd.news.page.update")}}" method="post" enctype="multipart/form-data" id="form-add-news">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" value="{{ $news->title }}" class="form-control" placeholder="{{trans('dhcd-news::language.form.title_placeholder')}}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{!! route('dhcd.art.demo.create') !!}"
                                   class="btn btn-danger">{{ trans('dhcd-news::language.buttons.discard') }}</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.col-sm-4 -->
