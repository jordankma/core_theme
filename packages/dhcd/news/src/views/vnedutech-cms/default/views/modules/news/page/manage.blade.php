...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-news::language.titles.page.list') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                         @if ($USER_LOGGED->canAccess('dhcd.news.page.create'))
                        <a href="{{ route('dhcd.news.page.create') }}" class="btn btn-sm btn-default">
                            <span class="glyphicon glyphicon-plus"></span> {{ trans('dhcd-news::language.buttons.create') }}
                        </a>
                        @endif
                    </div>
                </div>
