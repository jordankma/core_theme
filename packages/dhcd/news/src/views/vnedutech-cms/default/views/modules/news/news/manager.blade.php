...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-news::language.titles.news.list') }} @stop
{{-- page styles --}}
@section('header_styles')
    ...
    <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/datetimepicker/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" type="text/css"/>
     ...
     <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/dhcd/news/css/news/list.css') }}" rel="stylesheet" type="text/css"/>
@stop
<!--end of page css-->
{{-- Page content --}}
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" name='search-form' id='search-form' action="{{route('dhcd.news.news.manager')}}" method="get">
                        {{-- <input type="hidden" name="_token" value="{{ csrf_token() }}"/> --}}
                        <input type="hidden" name="visible" value="1"/>
                        <fieldset>
                            <div class='col-md-6'>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="name">{{ trans('dhcd-news::language.table.list_news.title') }}</label>
                                    <div class="col-md-8">
                                        <input id="name" name="name" type="text"  value="{{isset($request->name)?$request->name:null}}" class="form-control">
                                    </div>                                  
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" >{{ trans('dhcd-news::language.table.list_news.category') }}</label>
                                    <div class="col-md-8">
