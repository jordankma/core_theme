...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-news::language.titles.page.add') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form role="form" action="{{route("dhcd.news.page.add")}}" method="post" enctype="multipart/form-data" id="form-add-news">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{!! route('dhcd.news.page.create') !!}"
