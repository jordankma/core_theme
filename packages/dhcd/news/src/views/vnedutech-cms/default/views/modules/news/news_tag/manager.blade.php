...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-news::language.titles.news_tag.list') }} @stop
{{-- page styles --}}
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            @if ($USER_LOGGED->canAccess('dhcd.news.tag.create'))
                                <a href="{{ route('dhcd.news.tag.create') }}" class="btn btn-sm btn-default"><span
