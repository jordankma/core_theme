...
{	
	...
	public function manager(Request $request){
		return view('DHCD-NEWS::modules.news.page.manage');
	}
	public function create(){
		return view('DHCD-NEWS::modules.news.page.create');
	}
	public function add(NewsRequest $request){
		...
		if ($news->save()) {
            ...
            return redirect()->route('dhcd.news.page.manager')->with('success', trans('DHCD-NEWS::language.messages.success.create'));
        } else {
            return redirect()->route('dhcd.news.page.manager')->with('error', trans('DHCD-NEWS::language.messages.error.create'));
        }
	}
	...
	public function show(Request $request){
		...
		return view('DHCD-NEWS::modules.news.page.edit',$data);
	}	
	public function update(Request $request){
		...
		if ($news->save()) {
            ...
            return redirect()->route('dhcd.news.page.manager')->with('success', trans('DHCD-NEWS::language.messages.success.update'));
        } else {
            return redirect()->route('dhcd.news.page.manager')->with('error', trans('DHCD-NEWS::language.messages.error.update'));
        }		
	}
    ...
    public function data(Request $request)
    {
        ...
        return Datatables::of($list_news)
            ...
            ->addColumn('actions', function ($list_news) {
                $actions = '';
                if ($this->user->canAccess('dhcd.news.page.log')) {
                    $actions .= '<a href=' . route('dhcd.news.page.log', ['type' => 'page', 'news_id' => $list_news->news_id]) . ' data-toggle="modal" data-target="#log"><i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#F99928" data-hc="#F99928" title="log page"></i></a>';
                }
                if ($this->user->canAccess('dhcd.news.page.show')) {
                    $actions .= '<a href=' . route('dhcd.news.page.show', ['news_id' => $list_news->news_id]) . '><i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update page"></i></a>';
                }
                if ($this->user->canAccess('dhcd.news.page.confirm-delete')) {
                    $actions .=  '<a href=' . route('dhcd.news.page.confirm-delete', ['news_id' => $list_news->news_id]) . ' data-toggle="modal" data-target="#delete_confirm"><i class="livicon" data-name="trash" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete page"></i></a>';
                }
                return $actions;
            })
            ->rawColumns(['actions'])
