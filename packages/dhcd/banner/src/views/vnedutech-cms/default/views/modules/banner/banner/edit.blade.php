    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form role="form" action="{{route('dhcd.banner.banner.update')}}" method="post" enctype="multipart/form-data" id="form-edit-banner">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <textarea name="desc" class="form-control" value="{{$banner->desc}}" placeholder="{{trans('dhcd-banner::language.placeholder.banner.desc') }}"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="number" name="priority" class="form-control" value="{{$banner->priority}}" placeholder="{{trans('dhcd-banner::language.placeholder.banner.priority') }}">
                        </div>
