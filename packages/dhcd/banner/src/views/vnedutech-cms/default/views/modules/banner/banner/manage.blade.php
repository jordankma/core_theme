...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-banner::language.titles.banner.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('dhcd.banner.banner.create'))
                        <a href="{{ route('dhcd.banner.banner.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('dhcd-banner::language.buttons.create') }}</a>
                        @endif
                    </div>
                </div>
                <br/>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            <thead>
                            <tr class="filters">
                                <th class="fit-content">{{ trans('dhcd-banner::language.table.id') }}</th>
                                <th>{{ trans('dhcd-banner::language.table.banner.name') }}</th>
                                <th>{{ trans('dhcd-banner::language.table.banner.image') }}</th>
                                <th>{{ trans('dhcd-banner::language.table.banner.link') }}</th>
                                <th>{{ trans('dhcd-banner::language.table.banner.close_at') }}</th>
                                <th>{{ trans('dhcd-banner::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
