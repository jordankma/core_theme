...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-banner::language.titles.position.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form role="form" action="{{route('dhcd.banner.position.update')}}" method="post" id="form-add-position">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="number" min="0" name="height" value="{{$position->height}}"  class="form-control" placeholder="{{trans('dhcd-banner::language.placeholder.position.height') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
