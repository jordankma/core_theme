...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-banner::language.titles.position.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('dhcd.banner.position.create'))
                        <a href="{{ route('dhcd.banner.position.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th class="fit-content" style="width: 120px">{{ trans('dhcd-banner::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
