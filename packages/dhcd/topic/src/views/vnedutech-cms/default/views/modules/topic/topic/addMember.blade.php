                    ...
                    <div class="panel-body"> 
                        <div class="row">
                            ...
                            <div class="col-md-4" id="content-right">
                                ...
                                <div id="resultSearch">
                                    <form action="{{route('dhcd.topic.topic.add.member',['topic_id'=>$topic_id])}}" method="post">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        var table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('dhcd.topic.topic.data.member',['topic_id' => $topic_id]) }}',
            columns: [
        ...
        $("input.typeahead").keyup(function(){
            delay(function(){
                ...
                var url = '/admin/dhcd/topic/topic/search/member?keyword='+keyword+'&topic_id='+topic_id;
