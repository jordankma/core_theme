...
Route::group(array('prefix' => $adminPrefix), function() {
    Route::group(['middleware' => ['adtech.auth', 'adtech.acl']], function () {
        ...
        Route::get('dhcd/notification/notification/manage', 'NotificationController@manage')->name('dhcd.notification.notification.manage')->where('as','Quản lý thông báo');
        ...
        Route::get('dhcd/notification/log-sent/manage', 'LogSentController@manage')->name('dhcd.notification.log-sent.manage')->where('as','Thông báo đã gửi');
