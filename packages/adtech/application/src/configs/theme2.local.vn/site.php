...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'url_storage' => 'http://theme2.local.vn',
    'url_static' => 'http://theme2.local.vn',
...
//    ],
    ...
    'news_box' => [
        'renluyendoivien' => 'ren-luyen-doi-vien-360',
        'sotayrenluyen' => 'so-tay-ren-luyen',
        'thongbaohoidongdoi' => 'thong-bao-cua-hoi-dong-doi-tw',
        'hinhanhvideo' => 'video---hinh-anh-noi-bat'
    ],
    'news_cat' => [
        'renluyendoivien' => 'ren-luyen-doi-vien-360',
        'sotayrenluyen' => 'so-tay-ren-luyen',
