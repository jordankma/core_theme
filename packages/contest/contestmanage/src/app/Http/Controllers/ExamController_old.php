...
class ExamController_old extends Controller
{
...
//        $cond['finish_exam'] = true;
        ...
        if (!empty($request->class_id) && $request->class_id != 0) {
            $result_cond['class_id'] = (int)$request->class_id;
        }
        ...
        $result = ContestResult::with('candidate')
            ->whereHas('candidate', function ($query) use($member_cond, $name){
