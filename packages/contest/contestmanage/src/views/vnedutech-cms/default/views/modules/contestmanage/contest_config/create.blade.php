    ...
    $("[name='permission_locked']").bootstrapSwitch();
        ...
        function genConfig(config_idx, group_varible) {
            return '<div class="form-group" c-data="' +group_varible+'-'+ config_idx + '" id="' +group_varible+'-'+ config_idx + '">' +
                ...
                '<select class="form-control config_type" d-data="' + group_varible + '" c-data="' +group_varible+'-'+ config_idx + '" name="config[' + group_varible + '][type][]">' +
        ...
        $('body').on('change','.config_type',function () {
            ...
            var group_varible = $(this).attr('d-data');
            var html = '';
           if($('option:selected',this).val() == 'text'){
               ...
               html = '<div class="col-md-2">' +
                   ...
                   '</a> ' +
                   '</span> ' +
                   '<input class="form-control thumbnail" type="text" name="config[' + group_varible + '][value][]">' +
                   '</div>' +
                   '</div>';
           }
