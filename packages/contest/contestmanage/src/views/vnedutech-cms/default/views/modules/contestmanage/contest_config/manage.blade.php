                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('contest-contestmanage::language.table.contest_config.config_type') }}</th>
                                ...
                                <th>{{ trans('contest-contestmanage::language.table.contest_config.view') }}</th>
...
@section('footer_scripts')
        ...
        $(function () {
            var table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'config_id', name: 'view', "render": function (data) {
                        return '<a href="javascript:void(0)" class="btn btn-default view" c-data="'+ data +'"><span class="glyphicon glyphicon-eye-open"></span> Xem</a>';
                    } },
    ...
    <script>
        ...
        $('body').on('click','.view', function () {
            ...
            var route = '{{ route('contest.contestmanage.contest_config.view_detail') }}';
