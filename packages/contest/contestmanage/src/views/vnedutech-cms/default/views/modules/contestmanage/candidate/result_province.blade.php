                                ...
                                @if($value['params'] == 'province_id')
                                    <div class="col-md-4">
                                        <label>{{ $value['title'] }}</label>
                                            {!! Form::select($value['params'],$province_data, 0, array('class' => 'form-control '.$value['params'],'id' => $value['params'], 'autofocus'=>'autofocus','placeholder'=> $value['hint_text'])) !!}
                                    </div>
                                @else
                                    <div class="col-md-4">
                                        <label>{{ $value['title'] }}</label>
...
@section('footer_scripts')
    ...
    <script>
        ...
        $('body').on('click', '#btn_filter', function () {
            ...
            var route = '{{ route('contest.contestmanage.candidate.data_result') }}'
        ...
        $('body').on('click', '.export', function () {
                ...
                $.each(param_array, function (key, item) {
                    ...
                    if(item.type_view == 'input'){
                        ...
                        if(value != '' && value != null && value != 'undefined'){
                            if(str_param == ''){
                                str_param += '?' + item.params + '=' + $('#'+param).val();
                            }
                            else{
                                str_param += '&' + item.params + '=' + $('#'+param).val();
                            }
                        ...
                        if(value != '' && value != null && value != 'undefined'){
                            if(str_param == ''){
                                str_param += '?' + item.params + '=' + $('#'+param +' option:selected').val();
                            }
                            else{
                                str_param += '&' + item.params + '=' + $('#'+param +' option:selected').val();
                            }
            ...
            var link = route + str_param + '&module=result&alias=search_result';
