...
{{-- Page title --}}
@section('title'){{ $title = trans('contest-contestmanage::language.titles.form_load.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="panel panel-primary" id="hidepanel1">
                ...
                {!! Form::open(array('url' => route('contest.contestmanage.form_load.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'contestForm', 'files'=> true)) !!}
                <div class="panel-body ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->first('title', 'has-error') }}">
                                {!! Form::text('title', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.form_load.title'))) !!}
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->first('alias', 'has-error') }}">
                                {!! Form::text('alias', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contestmanage::language.placeholder.form_load.alias'))) !!}
                                <span class="help-block">{{ $errors->first('alias', ':message') }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Loại (*)</label>
                            <div class="form-group {{ $errors->first('env', 'has-error') }}">
                                {!! Form::select('env', $env,0, array('class' => 'form-control', 'autofocus'=>'autofocus')) !!}
                                <span class="help-block">{{ $errors->first('env', ':message') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        @foreach($target->general as $key => $value)
                                            <div class="form-group" id="{{ $value['id'] }}">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="hidden" name="general[{{ $value['params'] }}][field_id]" value="{{ $value['id'] }}" />
                                                </div>
                                                <div class="col-md-1">
                    ...
                    <div class="row form-group" id="target_container">
                        @if(!empty($target->target))
                            @foreach($target->target as $key2 => $value2)
                                <div class="panel panel-primary" >
                                    <div class="panel-body">
                                        <p class="text-on-pannel text-primary"><strong> {{ $value2['name'] }}</strong> <a class="glyphicon glyphicon-remove remove_target" title="Xóa"></a></p>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <a href="{!! route('contest.contestmanage.form_load.update') !!}"
...
@section('footer_scripts')
    ...
    <script>
        ...
        $('body').on('click', '.remove_target', function () {
