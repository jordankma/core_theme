    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('contest.exam.contest_list.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'contestForm', 'files'=> true)) !!}
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('db_mysql', 'has-error') }}">
                            {!! Form::text('db_mysql', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contest::language.placeholder.contest.name_here'))) !!}
                        ...
                        <div class="form-group {{ $errors->first('db_mongo', 'has-error') }}">
                            {!! Form::text('db_mongo', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('contest-contest::language.placeholder.contest.name_here'))) !!}
