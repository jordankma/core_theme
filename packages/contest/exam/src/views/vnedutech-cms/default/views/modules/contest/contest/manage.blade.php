            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('contest.exam.contest_list.create') }}" class="btn btn-sm btn-default"><span
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('contest-contest::language.table.contest.db_mysql') }}</th>
                                <th>{{ trans('contest-contest::language.table.contest.db_mongo') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('contest.exam.contest_list.data') }}',
                columns: [
                    { data: 'DT_Row_Index', name: 'contest_id' },
                    { data: 'name', name: 'name' },
                    { data: 'alias', name: 'alias' },
                    { data: 'domain_name', name: 'domain_name' },
                    { data: 'db_mysql', name: 'db_mysql' },
                    { data: 'db_mongo', name: 'db_mongo' },
